...
public class TestTest {
	public static void main(String[] args) {
		/*
		 * long ct = System.currentTimeMillis(); Date d = new Date(ct);
		...
		/*
		 * LogsDao ld = new LogsDao(); ld.readLogs();
		 * ld.writeLogs("1111222233336666", "2017年04月10日 09:51:49", 100000.0,
		 * 100000.0, 100000.0);
		 */
		/*
		 * UserDao u = UserDao.getUserDao(); String inputId =
		 * "1111222233336666"; double ban = u.getBalance(inputId); String id =
		 * u.getId(inputId); String pwd = u.getPwd(inputId); String name =
		 * u.getName(inputId);
